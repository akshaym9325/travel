function Reg() {
	...
	//For Body Type
	let bodytype = document.getElementById("destination").value;
	if (bodytype == "0") {
		document.getElementById("destinationmsg").innerHTML = "Please Select Destination..!";
		return false;
	}
	else {
		document.getElementById("destinationmsg").innerHTML = "";
	}
